...
namespace YuzeToolkit
{
    ...
    public static class McpValueFormatter
    {
        ...
        public static string ToMcpText(object? value, int depth = 4) =>
        ...
        public static Dictionary<string, object?> Describe(object? value, int depth = 4)
        {
            ...
            return formatted as Dictionary<string, object?> ?? McpData.Obj(("value", formatted));
        }
