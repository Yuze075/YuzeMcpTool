...
namespace YuzeToolkit
{
    ...
    public sealed class ScenesTool
    {
        ...
        [McpFunction("Get scene hierarchy.")]
        ...
        [McpFunction("Save scene as path.")]
