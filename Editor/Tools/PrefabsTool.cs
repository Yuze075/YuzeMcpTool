...
namespace YuzeToolkit
{
    ...
    {
        [EvalFunction("Instantiate prefab.")]
        ...
        [EvalFunction("Create prefab from object.")]
        ...
        [EvalFunction("Create prefab variant.")]
        ...
        [EvalFunction("Open Prefab Stage.")]
        ...
        [EvalFunction("Close Prefab Stage.")]
        ...
        [EvalFunction("Save Prefab Stage.")]
        ...
        [EvalFunction("Apply prefab overrides.")]
        ...
        [EvalFunction("Revert prefab overrides.")]
        ...
        [EvalFunction("Unpack prefab instance.")]
